# software_pip-pyapi-gitlab
=========

This role will install pip-pyapi-gitlab software
...
--------------------
    ...
    ---
    - src: git@github.com:xussof/software_pip-pyapi-gitlab
      scm: git
      version: master
      name: software_pip-pyapi-gitlab
